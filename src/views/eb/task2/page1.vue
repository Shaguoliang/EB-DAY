...
<mainPage>
  <div class="page flex column center ">
    <div class="flex1 cardBg">
      <a href="javascript:void(0)"><img src="../../../assets/eb/btnImg/task2-page1-text.png" alt=""></a>
    </div>
    <div class="flex center around btns">
      <div @click="goreplace('/eb/tasktow/page2')" class="flex1"><a href="javascript:void(0)"><img src="../../../assets/eb/btnImg/task2-page1-1.png" alt=""></a></div>
    </div>
  </div>
</mainPage>
</template>
